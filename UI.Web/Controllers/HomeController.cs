...
namespace UI.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await httpClient.GetAsync("http://localhost:3112/api/categories");
        ...
        public async Task<IActionResult> Create(Category category)
        {
            ...
            var responseMessage = await httpClient.PostAsync("http://localhost:3112/api/categories", content);
        ...
        {
            var httpClient = new HttpClient();
            var responseMessage = await httpClient.GetAsync("http://localhost:3112/api/categories/" + id);
            if (responseMessage.IsSuccessStatusCode)
            {
        ...
        public async Task<IActionResult> Edit(Category category)
        {
            ...
            var responseMessage = await client.PutAsync("http://localhost:3112/api/categories/", content);
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
        ...
        public async Task<IActionResult> Upload(IFormFile file)
        {
            ...
            using var httpClient = new HttpClient();
            var responseMessage = await httpClient.PostAsync("http://localhost:3112/api/categories/upload", formData);
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
